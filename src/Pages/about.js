    ...
    <>
      ...
      <div className="parallax">
        <div className="container mt-5 text-center">
          <h1 className="text-white display-4 fade-in-text fw-bold">
            About Us
          </h1>
          <div className="row align-items-center">
            ...
            <div className="col-md-6 order-md-1">
              <p className="lead fs-25 text-white ">
                ...
                dedicated to providing a rich and diverse collection of books
                for our readers, carrying forward the knowledge of generations.
                Our mission is to foster a love for reading, learning, and
                exploration.
              </p>
          ...
          <div className="row mt-5">
            <div className="col-md-6">
              ...
              <p className="text-white ">
                Empowering Minds Through Books: Our Vision for a Thriving
                Community Library!
              </p>
            </div>
            <div className="col-md-6">
              ...
              <p className="text-white ">
                Our mission is to curate a diverse collection of books that
                cater to all ages and interests. We aim to provide a welcoming
                environment where readers can explore new worlds, gain
                knowledge, and connect with fellow book enthusiasts.
              </p>
            </div>
          </div>
        </div>
